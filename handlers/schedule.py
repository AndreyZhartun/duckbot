...
def _format_day_schedule(day: date, events: list[Event]) -> str:
    """
    Builds the schedule block for a single day across both rooms.
    Free slots are filled between SCHEDULE_START_HOUR and SCHEDULE_END_HOUR.
    """
    ...
    for room in ROOM_ORDER:
        ...
        cursor = SCHEDULE_START_HOUR * 60  # minutes from midnight
